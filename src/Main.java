import ar.edu.unlu.poo.tp2.ej6.Cliente;
import ar.edu.unlu.poo.tp2.ej6.Combustible;
import ar.edu.unlu.poo.tp2.ej6.ModuloInformes;
...
public class Main {
    public static void main(String[] args) {
        ...
        a.getClientes().get(0).agregarVenta(LocalDate.now(), 100, a.getExpendedores().get(0), a.getEmpleados().get(0), 10);
        a.getClientes().get(0).agregarVenta(LocalDate.now(), 10, a.getExpendedores().get(0), a.getEmpleados().get(1), 1);
        a.getClientes().get(1).agregarVenta(LocalDate.now(), 20, a.getExpendedores().get(1), a.getEmpleados().get(2), 5);
        a.getClientes().get(2).agregarVenta(LocalDate.now(), 400, a.getExpendedores().get(2), a.getEmpleados().get(0), 80);
